...
class GetProductsRequestBean(BaseModel):
    """
    ...
    min_rating: Optional[StrictInt] = Field(default=None, alias="minRating")
    __properties: ClassVar[List[str]] = ["id", "productIds", "categoryId", "brandId", "minPrice", "maxPrice", "minRating"]

...
class CreateProductRequestBean(BaseModel):
    """
    ...
    gst: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["brandId", "categoryId", "productName", "productDescription", "imagePath", "basePrice", "gst"]

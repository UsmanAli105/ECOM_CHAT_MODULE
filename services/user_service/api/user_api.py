...
from user_service.api_client import ApiClient, RequestSerialized
from user_service.api_response import ApiResponse
from user_service.rest import RESTResponseType
...
class UserApi:
    ...
    def get_user_count(
        ...
        :param get_user_count_request: (required)
        :type get_user_count_request: GetUserCountRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_user_count_serialize(
    ...
    @validate_call
    def get_user_count_with_http_info(
        self,
        get_user_count_request: GetUserCountRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetUserCountResponse]:
        """get_user_count
    ...
    @validate_call
    def get_user_count_without_preload_content(
        self,
        get_user_count_request: GetUserCountRequest,
        _request_timeout: Union[
            None,
    ...
    def _get_user_count_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if get_user_count_request is not None:
            _body_params = get_user_count_request
